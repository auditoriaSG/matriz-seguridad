...
assert.deepEqual(JSON.parse(JSON.stringify(domain.normalizeState(null))),{values:{},groups:{}});
...
assert.deepEqual(JSON.parse(JSON.stringify(savedPayload)),{values:{x:'allow'},groups:{}});
